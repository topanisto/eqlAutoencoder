...
class Benchmark:
    ...
    def benchmark(self, func, func_name, trials):
        ...
        final_expression = expr_list_sorted[0]
    ...
    # def returnCalculation(self, final_expression, x_test):
    #     for 
    ...
    #     # Label and errors
    #     error = tf.losses.mean_squared_error(y_true=y, y_pred=y_hat)
    #     error_test = tf.losses.mean_squared_error(y_true=y_test, y_pred=y_hat)
